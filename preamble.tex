...
\usepackage{fancyhdr}
\newcommand{\disshorttitle}{Antibacterial Potential of \textit{Dipsacus inermis}: An in vitro Study}
...
\newcommand{\applydissheaders}{%
  ...
  \fancyhead[C]{%
    \footnotesize
    \begin{tabular}{@{}c@{}}
      Antibacterial Potential of \textit{Dipsacus inermis}: An in vitro Study\\
      Enrollment No.\ \disroll
    \end{tabular}%
  }%
